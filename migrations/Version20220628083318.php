 ...
 */
final class Version20220628083318 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE mission (id INT AUTO_INCREMENT NOT NULL, category_id INT DEFAULT NULL, contract_id INT NOT NULL, description LONGTEXT NOT NULL, title LONGTEXT NOT NULL, points INT NOT NULL, is_repeated TINYINT(1) NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_at DATETIME NOT NULL, start DATE NOT NULL, end DATE DEFAULT NULL, INDEX IDX_9067F23C12469DE2 (category_id), INDEX IDX_9067F23C2576E0FD (contract_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE rating (id INT AUTO_INCREMENT NOT NULL, mission_id INT NOT NULL, contract_id INT NOT NULL, parent_rating INT DEFAULT NULL, child_rating INT DEFAULT NULL, week DATE NOT NULL, INDEX IDX_D8892622BE6CAE90 (mission_id), INDEX IDX_D88926222576E0FD (contract_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE rating ADD CONSTRAINT FK_D88926222576E0FD FOREIGN KEY (contract_id) REFERENCES contract (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE rating DROP FOREIGN KEY FK_D88926222576E0FD');
