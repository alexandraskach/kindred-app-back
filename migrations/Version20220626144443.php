 ...
 */
final class Version20220626144443 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE mission (id INT AUTO_INCREMENT NOT NULL, category_id INT NOT NULL, contract_id INT NOT NULL, description LONGTEXT NOT NULL, title LONGTEXT NOT NULL, points INT NOT NULL, is_repeated TINYINT(1) NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_at DATETIME NOT NULL, start DATE NOT NULL, end DATE DEFAULT NULL, INDEX IDX_9067F23C12469DE2 (category_id), INDEX IDX_9067F23C2576E0FD (contract_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
